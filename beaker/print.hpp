...
std::ostream& operator<<(std::ostream&, Lshift_expr const&);
std::ostream& operator<<(std::ostream&, Rshift_expr const&);
std::ostream& operator<<(std::ostream&, Bitwise_or_expr const&);
std::ostream& operator<<(std::ostream&, Bitwise_and_expr const&);
std::ostream& operator<<(std::ostream&, Xor_expr const&);
